...
export default function Sidebar() {
  ...
  return (
    <div className="d-flex flex-column gap-2 px-lg-2 mt-lg-5 py-4 py-lg-0 scrollbody sideAdjust">
      <h1 className="text-secondary fs-6 mt-2 mt-lg-5 mb-1 mb-lg mb-lg-2 px-2">
        Discover
      </h1>
      {categories.map((category, index) => (
        ...
        >
          <div className="d-flex gap-2 align-items-center py-1 menu">
            <div style={{ fontSize: "1.3" }}>{category.icon}</div>
